!function () {
    ...
    if (t.length > 0) for (let a = 0; a < t.length; a++) {
        let l = t[a], c = l.getElementsByClassName("tq"), r = 0, o = l.getAttribute("data-autorotate");
    ...
    "use strict";
    const e = document.getElementById("tc"), t = document.getElementById("nj");
    ...
    "use strict";
    const e = document.getElementsByClassName("tw"), t = document.getElementsByClassName("modal-trigger");
    ...
    if (e.length > 0) for (let n = 0; n < e.length; n++) {
        const i = e[n], s = {el: i.querySelector("input")};
        ...
        const a = i.parentNode.querySelectorAll(".pricing-item-price"), l = [];
    ...
    function t(e, t) {
        ...
        !function (e) {
            const t = e.el.value / e.el.max, n = e.thumbSize * t, i = (e.thumbSize - e.currentValEl.clientWidth) / 2;
    ...
    if (e.length > 0) for (let n = 0; n < e.length; n++) {
        const i = e[n], s = i.querySelector("input"), a = i.parentNode.querySelectorAll(".pricing-item-price"), l = [];
        for (let e = 0; e < a.length; e++) {
            const t = a[e], n = {};
            n.currency = t.parentNode.querySelector(".pricing-item-price-currency"), n.amount = t.parentNode.querySelector(".pricing-item-price-amount"), n.after = t.parentNode.querySelector(".pricing-item-price-after"), n.data = JSON.parse(t.getAttribute("data-price-output")), l.push(n)
        }
